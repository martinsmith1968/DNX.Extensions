...
$template_filename = Join-Path $PSScriptRoot "ConversionExtensionsTestsDataSource.cs.template"
$output_filename = "Conversion#name#ExtensionsTestsDataSource" + $output_suffix
