#define MathsExtensionsTestsDataSource_Double
...
public class MathsDoubleExtensionsTestsDataSource
{
#if MathsExtensionsTestsDataSource_DateTime
    private static double CreateDataValue(int value)
#elif MathsExtensionsTestsDataSource_Guid
    private static double CreateDataValue(int value)
#else
    private static double CreateDataValue(double value)
#endif
    {
#if MathsExtensionsTestsDataSource_DateTime
    ...
    public static TheoryData<double, double, double, bool> IsBetween_Default()
    {
    ...
    public static TheoryData<double, double, double, IsBetweenBoundsType, bool> IsBetween_BoundsType()
    {
        return new TheoryData<double, double, double, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<double, double, double, bool> IsBetweenEither_Default()
    {
        return new TheoryData<double, double, double, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), true },
    ...
    public static TheoryData<double, double, double, IsBetweenBoundsType, bool> IsBetweenEither_BoundsType()
    {
        return new TheoryData<double, double, double, IsBetweenBoundsType, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), IsBetweenBoundsType.Inclusive, true },
    ...
    public static TheoryData<double, double, double, bool, IsBetweenBoundsType, bool> IsBetween()
    {
        return new TheoryData<double, double, double, bool, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<double, double, double> GetLowerBound_Default()
    {
    ...
    public static TheoryData<double, double, bool, double> GetLowerBound_AllowEitherOrder()
    {
        return new TheoryData<double, double, bool, double>()
        {
    ...
    public static TheoryData<double, double, double> GetUpperBound_Default()
    {
        return new TheoryData<double, double, double>()
        {
            { CreateDataValue(5), CreateDataValue(5), CreateDataValue(5) },
    ...
    public static TheoryData<double, double, bool, double> GetUpperBound_AllowEitherOrder()
    {
        return new TheoryData<double, double, bool, double>()
        {
