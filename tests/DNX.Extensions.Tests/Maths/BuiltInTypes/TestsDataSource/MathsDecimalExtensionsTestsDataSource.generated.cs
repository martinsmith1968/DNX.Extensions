#define MathsExtensionsTestsDataSource_Decimal
...
public class MathsDecimalExtensionsTestsDataSource
{
#if MathsExtensionsTestsDataSource_DateTime
    private static decimal CreateDataValue(int value)
#elif MathsExtensionsTestsDataSource_Guid
    private static decimal CreateDataValue(int value)
#else
    private static decimal CreateDataValue(decimal value)
#endif
    {
#if MathsExtensionsTestsDataSource_DateTime
    ...
    public static TheoryData<decimal, decimal, decimal, bool> IsBetween_Default()
    {
        return new TheoryData<decimal, decimal, decimal, bool>()
        {
    ...
    public static TheoryData<decimal, decimal, decimal, IsBetweenBoundsType, bool> IsBetween_BoundsType()
    {
        return new TheoryData<decimal, decimal, decimal, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<decimal, decimal, decimal, bool> IsBetweenEither_Default()
    {
        return new TheoryData<decimal, decimal, decimal, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), true },
    ...
    public static TheoryData<decimal, decimal, decimal, IsBetweenBoundsType, bool> IsBetweenEither_BoundsType()
    {
        return new TheoryData<decimal, decimal, decimal, IsBetweenBoundsType, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), IsBetweenBoundsType.Inclusive, true },
    ...
    public static TheoryData<decimal, decimal, decimal, bool, IsBetweenBoundsType, bool> IsBetween()
    {
        return new TheoryData<decimal, decimal, decimal, bool, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<decimal, decimal, decimal> GetLowerBound_Default()
    {
        return new TheoryData<decimal, decimal, decimal>()
        {
    ...
    public static TheoryData<decimal, decimal, bool, decimal> GetLowerBound_AllowEitherOrder()
    {
        return new TheoryData<decimal, decimal, bool, decimal>()
        {
    ...
    public static TheoryData<decimal, decimal, decimal> GetUpperBound_Default()
    {
        return new TheoryData<decimal, decimal, decimal>()
        {
            { CreateDataValue(5), CreateDataValue(5), CreateDataValue(5) },
    ...
    public static TheoryData<decimal, decimal, bool, decimal> GetUpperBound_AllowEitherOrder()
    {
        return new TheoryData<decimal, decimal, bool, decimal>()
        {
