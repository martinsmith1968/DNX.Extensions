#define MathsExtensionsTestsDataSource_Float
...
public class MathsFloatExtensionsTestsDataSource
{
#if MathsExtensionsTestsDataSource_DateTime
    private static float CreateDataValue(int value)
#elif MathsExtensionsTestsDataSource_Guid
    private static float CreateDataValue(int value)
#else
    private static float CreateDataValue(float value)
#endif
    {
#if MathsExtensionsTestsDataSource_DateTime
    ...
    public static TheoryData<float, float, float, bool> IsBetween_Default()
    {
        return new TheoryData<float, float, float, bool>()
        {
    ...
    public static TheoryData<float, float, float, IsBetweenBoundsType, bool> IsBetween_BoundsType()
    {
        return new TheoryData<float, float, float, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<float, float, float, bool> IsBetweenEither_Default()
    {
        return new TheoryData<float, float, float, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), true },
    ...
    public static TheoryData<float, float, float, IsBetweenBoundsType, bool> IsBetweenEither_BoundsType()
    {
        return new TheoryData<float, float, float, IsBetweenBoundsType, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), IsBetweenBoundsType.Inclusive, true },
    ...
    public static TheoryData<float, float, float, bool, IsBetweenBoundsType, bool> IsBetween()
    {
        return new TheoryData<float, float, float, bool, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<float, float, float> GetLowerBound_Default()
    {
        return new TheoryData<float, float, float>()
        {
    ...
    public static TheoryData<float, float, bool, float> GetLowerBound_AllowEitherOrder()
    {
        return new TheoryData<float, float, bool, float>()
        {
    ...
    public static TheoryData<float, float, float> GetUpperBound_Default()
    {
        return new TheoryData<float, float, float>()
        {
            { CreateDataValue(5), CreateDataValue(5), CreateDataValue(5) },
    ...
    public static TheoryData<float, float, bool, float> GetUpperBound_AllowEitherOrder()
    {
        return new TheoryData<float, float, bool, float>()
        {
