#define MathsExtensionsTestsDataSource_UInt64
...
public class MathsUInt64ExtensionsTestsDataSource
{
#if MathsExtensionsTestsDataSource_DateTime
    private static ulong CreateDataValue(int value)
#elif MathsExtensionsTestsDataSource_Guid
    private static ulong CreateDataValue(int value)
#else
    private static ulong CreateDataValue(ulong value)
#endif
    {
#if MathsExtensionsTestsDataSource_DateTime
    ...
    public static TheoryData<ulong, ulong, ulong, bool> IsBetween_Default()
    {
    ...
    public static TheoryData<ulong, ulong, ulong, IsBetweenBoundsType, bool> IsBetween_BoundsType()
    {
        return new TheoryData<ulong, ulong, ulong, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<ulong, ulong, ulong, bool> IsBetweenEither_Default()
    {
        return new TheoryData<ulong, ulong, ulong, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), true },
    ...
    public static TheoryData<ulong, ulong, ulong, IsBetweenBoundsType, bool> IsBetweenEither_BoundsType()
    {
        return new TheoryData<ulong, ulong, ulong, IsBetweenBoundsType, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), IsBetweenBoundsType.Inclusive, true },
    ...
    public static TheoryData<ulong, ulong, ulong, bool, IsBetweenBoundsType, bool> IsBetween()
    {
        return new TheoryData<ulong, ulong, ulong, bool, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<ulong, ulong, ulong> GetLowerBound_Default()
    {
    ...
    public static TheoryData<ulong, ulong, bool, ulong> GetLowerBound_AllowEitherOrder()
    {
        return new TheoryData<ulong, ulong, bool, ulong>()
        {
    ...
    public static TheoryData<ulong, ulong, ulong> GetUpperBound_Default()
    {
        return new TheoryData<ulong, ulong, ulong>()
        {
            { CreateDataValue(5), CreateDataValue(5), CreateDataValue(5) },
    ...
    public static TheoryData<ulong, ulong, bool, ulong> GetUpperBound_AllowEitherOrder()
    {
        return new TheoryData<ulong, ulong, bool, ulong>()
        {
