#define MathsExtensionsTestsDataSource_SByte
...
public class MathsSByteExtensionsTestsDataSource
{
#if MathsExtensionsTestsDataSource_DateTime
    private static sbyte CreateDataValue(int value)
#elif MathsExtensionsTestsDataSource_Guid
    private static sbyte CreateDataValue(int value)
#else
    private static sbyte CreateDataValue(sbyte value)
#endif
    {
#if MathsExtensionsTestsDataSource_DateTime
    ...
    public static TheoryData<sbyte, sbyte, sbyte, bool> IsBetween_Default()
    {
        return new TheoryData<sbyte, sbyte, sbyte, bool>()
        {
    ...
    public static TheoryData<sbyte, sbyte, sbyte, IsBetweenBoundsType, bool> IsBetween_BoundsType()
    {
        return new TheoryData<sbyte, sbyte, sbyte, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<sbyte, sbyte, sbyte, bool> IsBetweenEither_Default()
    {
        return new TheoryData<sbyte, sbyte, sbyte, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), true },
    ...
    public static TheoryData<sbyte, sbyte, sbyte, IsBetweenBoundsType, bool> IsBetweenEither_BoundsType()
    {
        return new TheoryData<sbyte, sbyte, sbyte, IsBetweenBoundsType, bool>()
        {
            { CreateDataValue(5), CreateDataValue(1), CreateDataValue(10), IsBetweenBoundsType.Inclusive, true },
    ...
    public static TheoryData<sbyte, sbyte, sbyte, bool, IsBetweenBoundsType, bool> IsBetween()
    {
        return new TheoryData<sbyte, sbyte, sbyte, bool, IsBetweenBoundsType, bool>()
        {
    ...
    public static TheoryData<sbyte, sbyte, sbyte> GetLowerBound_Default()
    {
        return new TheoryData<sbyte, sbyte, sbyte>()
        {
    ...
    public static TheoryData<sbyte, sbyte, bool, sbyte> GetLowerBound_AllowEitherOrder()
    {
        return new TheoryData<sbyte, sbyte, bool, sbyte>()
        {
    ...
    public static TheoryData<sbyte, sbyte, sbyte> GetUpperBound_Default()
    {
        return new TheoryData<sbyte, sbyte, sbyte>()
        {
            { CreateDataValue(5), CreateDataValue(5), CreateDataValue(5) },
    ...
    public static TheoryData<sbyte, sbyte, bool, sbyte> GetUpperBound_AllowEitherOrder()
    {
        return new TheoryData<sbyte, sbyte, bool, sbyte>()
        {
