...
namespace DNX.Extensions.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void IsGreaterThan(Expression<Func<short>> exp, short min)
        {
        ...
        public static void IsGreaterThan(Expression<Func<short>> exp, short val, short min)
        {
            if (val > min)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="min">The minimum.</param>
        public static void IsGreaterThanOrEqualTo(Expression<Func<short>> exp, short min)
        {
        ...
        /// <param name="min">The minimum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsGreaterThanOrEqualTo(Expression<Func<short>> exp, short val, short min)
        {
            if (val >= min)
            {
                return;
        ...
        public static void IsLessThan(Expression<Func<short>> exp, short max)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThan(Expression<Func<short>> exp, short val, short max)
        {
            if (val < max)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="max">The maximum.</param>
        public static void IsLessThanOrEqualTo(Expression<Func<short>> exp, short max)
        {
        ...
        /// <param name="max">The maximum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThanOrEqualTo(Expression<Func<short>> exp, short val, short max)
        {
            if (val <= max)
            {
                return;
        ...
        public static void IsBetween(Expression<Func<short>> exp, short min, short max)
        {
        ...
        public static void IsBetween(Expression<Func<short>> exp, short min, short max, IsBetweenBoundsType boundsType)
        {
        ...
        /// <param name="boundsType">Type of the bounds.</param>
        public static void IsBetween(Expression<Func<short>> exp, short bound1, short bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsBetween(Expression<Func<short>> exp, short val, short bound1, short bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
            ...
            throw new ArgumentOutOfRangeException(
                ...
                string.Format("{0} must be {1}",
                    ...
                    string.Format(boundsType.GetLimitDescriptionFormat(),
                        MathsInt16Extensions.GetLowerBound(bound1, bound2, allowEitherOrder),
                        MathsInt16Extensions.GetUpperBound(bound1, bound2, allowEitherOrder)
                        )
                    )
                );
        }
