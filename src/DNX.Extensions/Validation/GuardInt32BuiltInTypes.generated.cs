...
namespace DNX.Extensions.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void IsGreaterThan(Expression<Func<int>> exp, int min)
        {
        ...
        public static void IsGreaterThan(Expression<Func<int>> exp, int val, int min)
        {
            if (val > min)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="min">The minimum.</param>
        public static void IsGreaterThanOrEqualTo(Expression<Func<int>> exp, int min)
        {
        ...
        /// <param name="min">The minimum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsGreaterThanOrEqualTo(Expression<Func<int>> exp, int val, int min)
        {
            if (val >= min)
            {
                return;
        ...
        public static void IsLessThan(Expression<Func<int>> exp, int max)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThan(Expression<Func<int>> exp, int val, int max)
        {
            if (val < max)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="max">The maximum.</param>
        public static void IsLessThanOrEqualTo(Expression<Func<int>> exp, int max)
        {
        ...
        /// <param name="max">The maximum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThanOrEqualTo(Expression<Func<int>> exp, int val, int max)
        {
            if (val <= max)
            {
                return;
        ...
        public static void IsBetween(Expression<Func<int>> exp, int min, int max, IsBetweenBoundsType boundsType)
        {
        ...
        /// <param name="boundsType">Type of the bounds.</param>
        public static void IsBetween(Expression<Func<int>> exp, int bound1, int bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsBetween(Expression<Func<int>> exp, int val, int bound1, int bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
            ...
            throw new ArgumentOutOfRangeException(
                ...
                string.Format("{0} must be {1}",
                    ...
                    string.Format(boundsType.GetLimitDescriptionFormat(),
                        MathsInt32Extensions.GetLowerBound(bound1, bound2, allowEitherOrder),
                        MathsInt32Extensions.GetUpperBound(bound1, bound2, allowEitherOrder)
                        )
                    )
                );
        }
