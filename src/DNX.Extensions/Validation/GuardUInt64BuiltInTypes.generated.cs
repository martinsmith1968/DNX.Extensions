...
namespace DNX.Extensions.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void IsGreaterThan(Expression<Func<ulong>> exp, ulong min)
        {
        ...
        public static void IsGreaterThan(Expression<Func<ulong>> exp, ulong val, ulong min)
        {
            if (val > min)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="min">The minimum.</param>
        public static void IsGreaterThanOrEqualTo(Expression<Func<ulong>> exp, ulong min)
        {
        ...
        /// <param name="min">The minimum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsGreaterThanOrEqualTo(Expression<Func<ulong>> exp, ulong val, ulong min)
        {
            if (val >= min)
            {
                return;
        ...
        public static void IsLessThan(Expression<Func<ulong>> exp, ulong max)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThan(Expression<Func<ulong>> exp, ulong val, ulong max)
        {
            if (val < max)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="max">The maximum.</param>
        public static void IsLessThanOrEqualTo(Expression<Func<ulong>> exp, ulong max)
        {
        ...
        /// <param name="max">The maximum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThanOrEqualTo(Expression<Func<ulong>> exp, ulong val, ulong max)
        {
            if (val <= max)
            {
                return;
        ...
        public static void IsBetween(Expression<Func<ulong>> exp, ulong min, ulong max)
        {
        ...
        public static void IsBetween(Expression<Func<ulong>> exp, ulong min, ulong max, IsBetweenBoundsType boundsType)
        {
        ...
        /// <param name="boundsType">Type of the bounds.</param>
        public static void IsBetween(Expression<Func<ulong>> exp, ulong bound1, ulong bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsBetween(Expression<Func<ulong>> exp, ulong val, ulong bound1, ulong bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
            ...
            throw new ArgumentOutOfRangeException(
                ...
                string.Format("{0} must be {1}",
                    ...
                    string.Format(boundsType.GetLimitDescriptionFormat(),
                        MathsUInt64Extensions.GetLowerBound(bound1, bound2, allowEitherOrder),
                        MathsUInt64Extensions.GetUpperBound(bound1, bound2, allowEitherOrder)
                        )
                    )
                );
        }
