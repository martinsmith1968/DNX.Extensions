...
namespace DNX.Extensions.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void IsGreaterThan(Expression<Func<sbyte>> exp, sbyte min)
        {
        ...
        public static void IsGreaterThan(Expression<Func<sbyte>> exp, sbyte val, sbyte min)
        {
            if (val > min)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="min">The minimum.</param>
        public static void IsGreaterThanOrEqualTo(Expression<Func<sbyte>> exp, sbyte min)
        {
        ...
        /// <param name="min">The minimum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsGreaterThanOrEqualTo(Expression<Func<sbyte>> exp, sbyte val, sbyte min)
        {
            if (val >= min)
            {
                return;
        ...
        public static void IsLessThan(Expression<Func<sbyte>> exp, sbyte max)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThan(Expression<Func<sbyte>> exp, sbyte val, sbyte max)
        {
            if (val < max)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="max">The maximum.</param>
        public static void IsLessThanOrEqualTo(Expression<Func<sbyte>> exp, sbyte max)
        {
        ...
        /// <param name="max">The maximum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThanOrEqualTo(Expression<Func<sbyte>> exp, sbyte val, sbyte max)
        {
            if (val <= max)
            {
                return;
        ...
        public static void IsBetween(Expression<Func<sbyte>> exp, sbyte min, sbyte max)
        {
        ...
        public static void IsBetween(Expression<Func<sbyte>> exp, sbyte min, sbyte max, IsBetweenBoundsType boundsType)
        {
        ...
        /// <param name="boundsType">Type of the bounds.</param>
        public static void IsBetween(Expression<Func<sbyte>> exp, sbyte bound1, sbyte bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
