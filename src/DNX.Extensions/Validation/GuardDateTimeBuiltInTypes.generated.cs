...
namespace DNX.Extensions.Validation
{
    ...
    public static partial class Guard
    {
        ...
        public static void IsGreaterThan(Expression<Func<DateTime>> exp, DateTime min)
        {
        ...
        public static void IsGreaterThan(Expression<Func<DateTime>> exp, DateTime val, DateTime min)
        {
            if (val > min)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="min">The minimum.</param>
        public static void IsGreaterThanOrEqualTo(Expression<Func<DateTime>> exp, DateTime min)
        {
        ...
        /// <param name="min">The minimum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsGreaterThanOrEqualTo(Expression<Func<DateTime>> exp, DateTime val, DateTime min)
        {
            if (val >= min)
            {
                return;
        ...
        public static void IsLessThan(Expression<Func<DateTime>> exp, DateTime max)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThan(Expression<Func<DateTime>> exp, DateTime val, DateTime max)
        {
            if (val < max)
            {
                return;
        ...
        /// <param name="exp">The exp.</param>
        /// <param name="max">The maximum.</param>
        public static void IsLessThanOrEqualTo(Expression<Func<DateTime>> exp, DateTime max)
        {
        ...
        /// <param name="max">The maximum.</param>
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsLessThanOrEqualTo(Expression<Func<DateTime>> exp, DateTime val, DateTime max)
        {
            if (val <= max)
            {
                return;
        ...
        public static void IsBetween(Expression<Func<DateTime>> exp, DateTime min, DateTime max)
        {
        ...
        public static void IsBetween(Expression<Func<DateTime>> exp, DateTime min, DateTime max, IsBetweenBoundsType boundsType)
        {
        ...
        /// <param name="boundsType">Type of the bounds.</param>
        public static void IsBetween(Expression<Func<DateTime>> exp, DateTime bound1, DateTime bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException"></exception>
        public static void IsBetween(Expression<Func<DateTime>> exp, DateTime val, DateTime bound1, DateTime bound2, bool allowEitherOrder, IsBetweenBoundsType boundsType)
        {
