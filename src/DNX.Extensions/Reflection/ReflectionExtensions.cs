...
public static class ReflectionExtensions
{
    ...
    /// <param name="propertyName">Name of the property.</param>
    /// <returns>System.Object.</returns>
    public static object GetNestedPropertyValueByName(this object instance, string propertyName)
    {
        var propertyNames = propertyName.Split(".".ToCharArray());
        ...
        var returnValue = childPropertyNames.Any()
            ? GetNestedPropertyValueByName(instanceValue, childPropertyNamesText)
            : instanceValue;
