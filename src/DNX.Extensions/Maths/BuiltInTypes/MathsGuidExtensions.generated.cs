...
/// <summary>
/// Class MathGuidExtensions.
/// </summary>
public static class MathsGuidExtensions
{
    /// <summary>
    ...
    public static bool IsBetween(this Guid value, Guid min, Guid max)
    {
    ...
    public static bool IsBetween(this Guid value, Guid min, Guid max, IsBetweenBoundsType boundsType)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns><c>true</c> if the specified minimum is between min and max; otherwise, <c>false</c>.</returns>
    public static bool IsBetweenEither(this Guid value, Guid min, Guid max)
    {
        return value.IsBetween(min, max, IsBetweenBoundsType.Inclusive);
    }
    ...
    public static bool IsBetweenEither(this Guid value, Guid min, Guid max, IsBetweenBoundsType boundsType)
    {
    ...
    /// </returns>
    public static bool IsBetween(this Guid value, Guid min, Guid max, bool allowEitherOrder, IsBetweenBoundsType boundsType)
    {
    ...
    public static Guid GetLowerBound(Guid min, Guid max)
    {
    ...
    /// <param name="allowEitherOrder">if set to <c>true</c> allow min/max in either order</param>
    /// <returns>Guid</returns>
    public static Guid GetLowerBound(Guid min, Guid max, bool allowEitherOrder)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>Guid</returns>
    public static Guid GetUpperBound(Guid min, Guid max)
    {
    ...
    /// <param name="allowEitherOrder">if set to <c>true</c> allow min/max in either order</param>
    /// <returns>Guid</returns>
    public static Guid GetUpperBound(Guid min, Guid max, bool allowEitherOrder)
    {
        return allowEitherOrder
#if MathsExtensionsGuid
            ? min.ToBigInteger() > max.ToBigInteger() ? min : max
