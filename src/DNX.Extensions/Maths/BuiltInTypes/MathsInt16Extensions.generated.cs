...
public static class MathsInt16Extensions
{
    ...
    public static short GetLowerBound(short min, short max)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>short</returns>
    public static short GetUpperBound(short min, short max)
    {
