...
/// </summary>
public static class MathsInt64Extensions
{
    /// <summary>
    ...
    public static long GetLowerBound(long min, long max)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>long</returns>
    public static long GetUpperBound(long min, long max)
    {
