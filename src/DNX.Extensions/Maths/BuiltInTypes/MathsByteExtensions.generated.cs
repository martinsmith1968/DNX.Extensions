...
public static class MathsByteExtensions
{
    ...
    public static byte GetLowerBound(byte min, byte max)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>byte</returns>
    public static byte GetUpperBound(byte min, byte max)
    {
