...
public static class MathsDoubleExtensions
{
    ...
    public static double GetLowerBound(double min, double max)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>double</returns>
    public static double GetUpperBound(double min, double max)
    {
