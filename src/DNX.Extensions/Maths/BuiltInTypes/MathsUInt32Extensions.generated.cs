...
public static class MathsUInt32Extensions
{
    ...
    public static uint GetLowerBound(uint min, uint max)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>uint</returns>
    public static uint GetUpperBound(uint min, uint max)
    {
