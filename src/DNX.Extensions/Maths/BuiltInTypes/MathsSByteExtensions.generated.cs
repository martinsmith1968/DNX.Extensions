...
/// </summary>
public static class MathsSByteExtensions
{
    /// <summary>
    ...
    public static sbyte GetLowerBound(sbyte min, sbyte max)
    {
    ...
    /// <param name="max">The maximum.</param>
    /// <returns>sbyte</returns>
    public static sbyte GetUpperBound(sbyte min, sbyte max)
    {
